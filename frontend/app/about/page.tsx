        ...
        <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-3xl mx-auto">
              ...
              Qonnect WiFi has grown to serve thousands of customers across Kenya.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <div className="space-y-4 text-slate-600 dark:text-slate-400">
                <p>
                  Qonnect WiFi was born from a simple observation: internet access in Kenya was either too expensive or
